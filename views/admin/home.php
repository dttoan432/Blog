              ...
              <div class="card">
                ...
                <div class="card-body">
                  <ul class="list-unstyled list-unstyled-border">
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="public/admin/img/avatar/avatar-1.png" alt="avatar">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="public/admin/img/avatar/avatar-2.png" alt="avatar">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="public/admin/img/avatar/avatar-3.png" alt="avatar">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="public/admin/img/avatar/avatar-4.png" alt="avatar">
                      <div class="media-body">
                  ...
                  <div class="summary">
                    ...
                    <div class="summary-item">
                      ...
                      <ul class="list-unstyled list-unstyled-border">
                        <li class="media">
                          <a href="#">
                            <img class="mr-3 rounded" width="50" src="public/admin/img/products/product-1-50.png" alt="product">
                          </a>
                          <div class="media-body">
                        ...
                        <li class="media">
                          <a href="#">
                            <img class="mr-3 rounded" width="50" src="public/admin/img/products/product-2-50.png" alt="product">
                          </a>
                          <div class="media-body">
                        ...
                        <li class="media">
                          <a href="#">
                            <img class="mr-3 rounded" width="50" src="public/admin/img/products/product-3-50.png" alt="product">
                          </a>
                          <div class="media-body">
                ...
                <div class="card-body">
                  <ul class="list-unstyled list-unstyled-border">
                    ...
                    <li class="media">
                      ...
                      <img class="mr-3 rounded-circle" width="50" src="public/admin/img/avatar/avatar-5.png" alt="avatar">
                      <div class="media-body">
