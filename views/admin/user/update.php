            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <form action="index.php?admin=admin&mod=user&act=update&id=<?= $user['id']?>" method="POST" enctype="multipart/form-data" class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="permission" <?= ($user['permission'] == 1) ? 'checked' : '' ?> value="1">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="permission" <?= ($user['permission'] == 1) ? '' : 'checked' ?> value="0">
                          <label class="form-check-label" for="flexRadioDefault2">
                            Nhân viên
                          </label>
                        </div>
